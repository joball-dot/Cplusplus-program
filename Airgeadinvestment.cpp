...
int main()
{
	//calls displayMenu funciton
	displayMenu();

	//Wait for input from user
	system("PAUSE");

	//calls userData function
	userData();
	...
	//calls the yearDataWithoutDeposits function
	yearDataWithoutDeposits();
	
	//Set total amount to initial investment to be updated
	totalAm = initInv;

	//calls the yearDataWithDeposits function
	yearDataWithDeposits();
